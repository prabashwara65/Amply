          ...
          <div className="p-6 space-y-3">
            {recentOwners.map((owner) => (
              <div key={owner.nic} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200 hover:border-gray-300 transition-colors">
                ...
                <div className="text-right">
                  <span className={`px-2 py-1 rounded text-xs font-medium ${owner.status === "active" ? "bg-gray-900 text-white" : "bg-gray-200 text-gray-700 border border-gray-300"}`}>{owner.status}</span>
