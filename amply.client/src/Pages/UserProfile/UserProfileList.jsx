...
export default function EVOwnersPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    const handleSubmit = async (e) => {
        ...
        // Auto set role as EvOwner
        const submitData = { ...formData, role: "EvOwner" }

        try {
            if (isEdit) {
                await updateUserProfile(editNIC, submitData)
            } else {
    ...
    const validateNIC = (nic) => {
        ...
        return "NIC must be either 12 digits (new NIC) or 9 digits followed by 'V' or 'X' (old NIC)";
    }
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent ${errors.nic ? "border-red-500" : "border-gray-300"
                                            }`}
                                        disabled={isEdit}
                                    />
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent ${errors.email ? "border-red-500" : "border-gray-300"
                                            }`}
                                    />
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent ${errors.phone ? "border-red-500" : "border-gray-300"
                                            }`}
                                    />
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent pr-10 ${errors.password ? "border-red-500" : "border-gray-300"
                                                }`}
                                        />
                                        <button
                                            type="button"
